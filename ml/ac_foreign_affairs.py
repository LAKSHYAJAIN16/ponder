...
async def scrape_ac_foreign_affairs(debug=False, save=True):
    browser = await launch()
    page = await browser.newPage()
    await page.goto("https://www.theamericanconservative.com/category/foreign-affairs/")
    ...
    if save == True:
        save_file(return_obj, "american-conservative-fa")
    return return_obj
