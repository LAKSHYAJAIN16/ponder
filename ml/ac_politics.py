...
async def scrape_ac_politics(debug=False, save=True):
    browser = await launch()
    page = await browser.newPage()
    await page.goto("https://www.theamericanconservative.com/category/politics/")
    ...
    if save:
        save_file(return_obj, "american-conservative-politics")
    return return_obj
